...
1. Defaults baked into [src/lib/config.ts](../src/lib/config.ts)
2. `data/config.json`
...
Generated by setup; safe to edit while the bot is stopped. Shape mirrors [src/lib/config.ts](../src/lib/config.ts).
